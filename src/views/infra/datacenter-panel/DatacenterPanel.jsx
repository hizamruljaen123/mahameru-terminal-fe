...
export default function DatacenterPanel() {
    ...
    return (
        <div class="h-full w-full flex flex-col bg-bg_main overflow-hidden uppercase relative" style="font-family: 'Roboto', sans-serif;">
            
            {/* DATA AUDIT CONSOLE FOR UNMAPPED RECORDS - OVERLAY OR SEPARATE LAYER */}
            <div 
                class="absolute inset-0 z-[2000] bg-bg_main flex flex-col transition-all duration-500"
                class:hidden={activeTableTab() !== 'hub_orphans'}
                class:animate-in={activeTableTab() === 'hub_orphans'}
                class:fade-in={activeTableTab() === 'hub_orphans'}
            >
                <div class="px-8 py-4 bg-black/40 border-b border-border_main flex justify-between items-center backdrop-blur-3xl">
                    <div>
