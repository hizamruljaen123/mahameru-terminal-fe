...
export default defineConfig({
  ...
  server: {
    port: 5151,
    headers: {
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' unpkg.com cdn.jsdelivr.net cdnjs.cloudflare.com cdn.plot.ly code.jquery.com s3.tradingview.com; style-src 'self' 'unsafe-inline' unpkg.com fonts.googleapis.com; img-src 'self' data: blob: unpkg.com cdn.jsdelivr.net *.tile.openstreetmap.org *.openstreetmap.org; connect-src 'self' unpkg.com api.asetpedia.online *.api.asetpedia.online wss://api.asetpedia.online; font-src 'self' fonts.gstatic.com; frame-src 'self' youtube.com *.youtube.com s3.tradingview.com sslecal2.investing.com;",
